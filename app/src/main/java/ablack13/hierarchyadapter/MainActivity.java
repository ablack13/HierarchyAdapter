...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Item> fillData() {
        ...
        items.add(new Item("sdsddsdsdsds", 2, "fddkfg"));
        items.add(new Item("kkkk", 1, "rock"));
        items.add(new Item("ura_huylo", 2, "kkkk"));
        items.add(new Item("noo", 3, "ura_huylo"));
        items.add(new Item("test", 1, "rock"));
        items.add(new Item("7878", 1, "rock"));
        items.add(new Item("New folder", 1, "rock"));
        items.add(new Item("play", 2, "New folder"));
        items.add(new Item("football", 1, "rock"));
        items.add(new Item("fff", 2, "football"));
        ...
        items.add(new Item("dfdf", 2, "sassa"));
        items.add(new Item("fgfgfg", 3, "dfdf"));
        items.add(new Item("ккук", 4, "fgfgfg"));
        items.add(new Item("sss", 5, "ккук"));
        items.add(new Item("sddssd", 6, "sss"));
        items.add(new Item("lock door", 5, "ккук"));
        ...
        items.add(new Item("кккк", 2, "eeee111"));
