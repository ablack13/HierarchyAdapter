...
class HierarchyRecyclerViewAdapterHelper<T extends HierarchyItem, VH extends RecyclerViewHierarchyAdapter.HierarchyViewHolder> {
    ...
    public HierarchyRecyclerViewAdapterHelper(Context context, RecyclerViewHierarchyAdapter<T, VH> adapter) {
